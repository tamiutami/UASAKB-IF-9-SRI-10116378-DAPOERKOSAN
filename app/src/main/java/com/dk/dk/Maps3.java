...
public class Maps3 extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {

    private Location mLastLocation;
    private Button btLocation;
    private GoogleApiClient mGoogleApiClient;

    private String API_KEY_SERVER = "AIzaSyDQInhW6wEfxkDfzrhq18X_7l8k13L8KoY";
    ...
    private class PlacesTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(Maps3.this);
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<HashMap<String, String>>> {
        ...
        protected void onPostExecute(List<HashMap<String, String>> list) {
            ...
            Toast.makeText(Maps3.this, "Menemukan " + totalToko + "Rumah Makan", Toast.LENGTH_LONG).show();
        }
